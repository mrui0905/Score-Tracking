...
if __name__ == '__main__':
    ...
    raw_paths = ['data/addition_raw.csv', 'data/subtraction_raw.csv', 'data/multiplication_raw.csv', 'data/division_raw.csv', 'data/combined_raw.csv']
    avg_paths = ['data/addition_avg.csv', 'data/subtraction_avg.csv', 'data/multiplication_avg.csv', 'data/division_avg.csv', 'data/combined_avg.csv']
